...
public class RegisterActivity extends BaseActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 0x123) {
                ...
                registerSendIdentify.setText(code + "s");
            } else if (msg.what == 0x321) {
                registerSendIdentify.setText("获取验证码");
                registerSendIdentify.setClickable(true);
            }
        }
    };
    ...
    private void check_code(final String phone, String code) {
        ...
        SubscriberOnNextListener onNextListener = new SubscriberOnNextListener<String>() {
            ...
            public void onNext(String s) {
                ...
                goActivity(bundle, SetPassActivity.class);
            }
        };
    ...
    private void countdown() {
        registerSendIdentify.setClickable(false);

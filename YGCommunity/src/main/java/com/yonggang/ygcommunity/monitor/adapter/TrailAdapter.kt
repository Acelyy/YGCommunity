...
class TrailAdapter(var data: EventDetail, var context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder?, position: Int) {
        when (getItemViewType(position)) {
            TYPE_HEAD -> {
                ...
                if (data.info.faceurl != null && data.info.faceurl != "")
                    Glide.with(context).load(data.info.faceurl).into(holder.bbs_head)
                else
                    Glide.with(context).load(R.mipmap.pic_head).into(holder.bbs_head)
                holder.bbs_name?.text = data.info.username
                ...
                if (data.info.count == null || data.info.position == null) {
                    ...
                    holder.bbs_comment?.text = data.info.count
                    holder.bbs_location?.text = data.info.position
                }
                if (data.info.img == null || data.info.img.isEmpty()) {
                    holder.layout_pic?.visibility = View.GONE
                    holder.layout_pic2?.visibility = View.GONE
                } else {
                    when (data.info.img.size) {
                        1 -> {
                            ...
                            Glide.with(context).load(data.info.img[0]).centerCrop().into(holder.bbs_pic)
                        ...
                        2 -> {
                            ...
                            Glide.with(context).load(data.info.img[0]).centerCrop().into(holder.bbs_pic)
                            Glide.with(context).load(data.info.img[1]).centerCrop().into(holder.bbs_pic2)
                            holder.bbs_pic?.setOnClickListener { onImageClickListener.onImageClick(it, 0) }
                        ...
                        3 -> {
                            ...
                            Glide.with(context).load(data.info.img[0]).centerCrop().into(holder.bbs_pic)
                            Glide.with(context).load(data.info.img[1]).centerCrop().into(holder.bbs_pic2)
                            Glide.with(context).load(data.info.img[2]).centerCrop().into(holder.bbs_pic3)
                            holder.bbs_pic?.setOnClickListener { onImageClickListener.onImageClick(it, 0) }
                            holder.bbs_pic2?.setOnClickListener { onImageClickListener.onImageClick(it, 1) }
                        ...
                        4 -> {
                            ...
                            Glide.with(context).load(data.info.img[1]).centerCrop().into(holder.bbs_pic2)
                            Glide.with(context).load(data.info.img[2]).centerCrop().into(holder.bbs_pic3)
                            Glide.with(context).load(data.info.img[3]).centerCrop().into(holder.bbs_pic4)
                            holder.bbs_pic?.setOnClickListener { onImageClickListener.onImageClick(it, 0) }
                            holder.bbs_pic2?.setOnClickListener { onImageClickListener.onImageClick(it, 1) }
                            holder.bbs_pic3?.setOnClickListener { onImageClickListener.onImageClick(it, 2) }
                        ...
                        5 -> {
                            ...
                            Glide.with(context).load(data.info.img[2]).centerCrop().into(holder.bbs_pic3)
                            Glide.with(context).load(data.info.img[3]).centerCrop().into(holder.bbs_pic4)
                            Glide.with(context).load(data.info.img[4]).centerCrop().into(holder.bbs_pic5)
                            holder.bbs_pic?.setOnClickListener { onImageClickListener.onImageClick(it, 0) }
                            holder.bbs_pic2?.setOnClickListener { onImageClickListener.onImageClick(it, 1) }
                            holder.bbs_pic3?.setOnClickListener { onImageClickListener.onImageClick(it, 2) }
                            holder.bbs_pic4?.setOnClickListener { onImageClickListener.onImageClick(it, 3) }
